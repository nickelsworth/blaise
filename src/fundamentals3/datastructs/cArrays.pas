...
const
  ...
  UnitCopyright = 'Copyright (c) 1999-2003 David J Butler';
...
type
  ...
  public
    ...
    function  AppendArray(const V: InterfaceArray): Integer; reintroduce; overload; virtual;
...
type
  ...
  public
    constructor Create(const V: PointerArray = nil); reintroduce; overload;
    ...
    { APointerArray                                                            }
    procedure Assign(const V: PointerArray); reintroduce; overload;
    procedure Assign(const V: Array of Pointer); reintroduce; overload;
...
type
  ...
  public
    constructor Create(const V: InterfaceArray = nil); reintroduce; overload;
    ...
    { AInterfaceArray                                                            }
    procedure Assign(const V: InterfaceArray); reintroduce; overload;
    procedure Assign(const V: Array of IInterface); reintroduce; overload;
...
begin
  ...
  if V is ALongIntArray then
    ...
    TypeError(ClassName + ' can not append ' + ObjectClassName(V));
end;
