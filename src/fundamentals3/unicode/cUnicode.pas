{                                                                              }
{                        Unicode string functions v3.05                        }
{                                                                              }
...
function  WideZPosAnsiCharSet(const F: CharSet; const P: PWideChar): Integer;
...
function  WideZExtractBeforeAnsiChar(const Ch: Char; var P: PWideChar;
          var S: WideString): Boolean;
function  WideZExtractBeforeAnsiCharSet(const C: CharSet; var P: PWideChar;
          var S: WideString): Boolean;
...
function WideZExtractBeforeAnsiCharSet(const C: CharSet; var P: PWideChar; var S: WideString): Boolean;
var I : Integer;
begin
